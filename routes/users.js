...
//     bcrypt.compare('2', hash, (err, result) => {
//       console.log(result);
...
/*Дз:
  сделать обработку ошибок в signin 
  пользователь может ошибиться либо в пароле либо в своем email
  Делать предупреждение: мб вы хотите зарегистрироваться
